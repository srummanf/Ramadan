...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-emerald-900 text-emerald-50 hover:bg-emerald-900/90",
        destructive:
          "bg-red-500 text-emerald-50 hover:bg-red-500/90",
        outline:
          "border border-emerald-200 bg-white hover:bg-emerald-100 hover:text-emerald-900",
        secondary:
          "bg-emerald-100 text-emerald-900 hover:bg-emerald-100/80",
