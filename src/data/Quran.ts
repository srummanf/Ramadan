    ...
    summary: [
      {
        ...
        description:
          "Allah granted some prophets higher ranks than others. Musa (Moses) spoke directly to Allah, Isa (Jesus) was given miracles, and Muhammad ﷺ was given the final revelation (Quran). Some prophets were given clear signs, while others were given specific responsibilities.",
        lesson: [
      ...
      },
      {
        ...
        description:
          "Ayat al-Kursi describes Allah's absolute sovereignty, knowledge, and power. It affirms that He is the Ever-Living, Self-Sustaining, and that nothing happens without His permission. His knowledge encompasses all things, and He is never weary of protecting His creation.",
        lesson: [
      ...
      },
      {
        ...
        description:
          "Islam does not force anyone to accept faith. The truth is clear from falsehood, and people must choose belief willingly. Faith must come from the heart, and coercion is against the principles of Islam.",
        lesson: [
      ...
      },
      {
        ...
        description:
          "Giving charity is compared to planting a single seed that grows into 700 times more. Allah rewards those who spend sincerely for His cause.",
        lesson: [
      ...
      },
      {
        ...
        description:
          "Those who give charity seeking Allah's pleasure will have rewards, while those who give for show will have no benefit from their charity.",
        lesson: [
      ...
      },
      {
        ...
        description:
          "Allah strictly forbids interest-based transactions, as they exploit the poor and corrupt economic justice. Instead, business and trade are encouraged.",
        lesson: [
      ...
      },
      {
        ...
        description:
          "Allah commands believers to document financial transactions with witnesses to ensure justice and prevent disputes.",
        lesson: [
      ...
      },
      {
        ...
        description:
          "Allah does not burden a soul beyond its capacity. This verse is a supplication seeking forgiveness, mercy, and strength in faith.",
        lesson: [
      ...
      },
      {
        ...
        description:
          "Allah revealed the Quran as the final scripture, confirming the Torah and the Gospel. It serves as guidance for humanity.",
        lesson: [
      ...
      },
      {
        ...
        description:
          "Some Quranic verses have clear meanings, while others are allegorical. Only Allah knows the complete interpretation of the hidden meanings.",
        lesson: [
      ...
      },
      {
        ...
        description:
          "Allah gives kingdom to whom He wills and takes it away from whom He wills. He controls life, death, and provisions.",
        lesson: [
      ...
      },
      {
        ...
        description:
          "Allah commands believers to follow the teachings of Prophet Muhammad ﷺ as a sign of true love for Allah.",
        lesson: [
      ...
      },
      {
        ...
        description:
          "Maryam's mother dedicated her to Allah's service. Despite expecting a son, she embraced Allah's plan and Maryam became one of the most honored women in history.",
        lesson: [
      ...
      },
      {
        ...
        description:
          "Angel Jibreel (Gabriel) announced to Maryam that she would give birth to Isa (Jesus) without a father. This miraculous birth was a sign from Allah.",
        lesson: [
      ...
      },
      {
        ...
        description:
          "The disbelievers plotted against Isa (Jesus), but Allah's plan was superior. He protected Isa and raised him to Himself.",
        lesson: [
      ...
      },
      {
        ...
        description:
          "Allah assures that those who do good deeds and believe in Him will be fully rewarded, while the wrongdoers will not find any help.",
        lesson: [
      ...
      },
      {
        ...
        description:
          "Isa’s (Jesus) creation is compared to Adam’s. Allah created him without a father, just as Adam was created from dust without parents.",
        lesson: [
      ...
      },
      {
        ...
        description:
          "Allah instructs Prophet Muhammad ﷺ to invite Christians to a 'Mubahala'—a challenge where both parties pray for Allah’s curse on the liars, proving Islam’s truth.",
        lesson: [
      ...
      },
      {
        ...
        description:
          "Allah calls for unity among Muslims, Jews, and Christians, emphasizing monotheism and worshiping Allah alone.",
        lesson: [
      ...
      },
      {
        ...
        description:
          "Ibrahim (Abraham) was neither Jewish nor Christian—he was a pure monotheist who submitted fully to Allah.",
        lesson: [
      ...
      },
      {
        ...
        description:
          "Allah warns against those who try to mislead believers. True guidance comes from Allah, and no one can change His decree.",
        lesson: [
      ...
      },
      {
        ...
        description:
          "No prophet ever asked people to worship him instead of Allah. Their role was to guide people towards the Creator, not themselves.",
        lesson: [
      ...
      },
      {
        ...
        description:
          "Everything in the heavens and the earth submits to Allah, willingly or unwillingly. Islam is the natural way of life for all creation.",
        lesson: [
      ...
      },
      {
        ...
        description:
          "Allah states that any religion other than Islam will not be accepted, as Islam is the final and complete guidance.",
        lesson: [
      ...
      },
      {
        ...
        description:
          "Allah promises forgiveness to those who sincerely repent and reform their ways, showing His immense mercy.",
        lesson: [
      ...
      },
      {
        ...
        description:
          "True piety is shown by giving away things you love for the sake of Allah. Only through sacrifice and generosity can faith be perfected.",
        lesson: [
...
export const hadiths: Hadith[] = [
  ...
  },
  {
    id: 3,
    category: "Fasting",
    text: "Fasting is a shield; so when one of you is fasting, he should neither indulge in obscene language nor raise his voice in anger. If someone attacks or insults him, let him say: 'I am fasting.'",
    source: "Sahih Al-Bukhari",
  ...
  },
  {
    id: 4,
    category: "Virtues",
    text: "The smell of the mouth of a fasting person is more fragrant to Allah than the smell of musk.",
    source: "Sahih Muslim",
    chapter: "Book of Fasting, 1151",
    narrator: "Abu Huraira",
  },
  {
    id: 5,
    category: "Ramadan",
    text: "Whoever establishes prayers during the nights of Ramadan faithfully out of sincere faith and hoping to attain Allah’s rewards, all his past sins will be forgiven.",
    source: "Sahih Al-Bukhari",
    chapter: "Book of Tarawih, 2008",
    narrator: "Abu Huraira",
  },
  {
    id: 6,
    category: "Fasting",
    text: "There are two moments of joy for the fasting person: one when he breaks his fast and the other when he meets his Lord.",
    source: "Sahih Al-Bukhari",
    chapter: "Book of Fasting, 1904",
    narrator: "Abu Huraira",
  },
  {
    ...
    chapter: "Book of Zakat, 663",
    narrator: "Ibn Abbas",
  },
  {
    id: 8,
    category: "Lailatul Qadr",
    text: "Seek Lailatul Qadr in the last ten nights of Ramadan.",
    source: "Sahih Al-Bukhari",
    chapter: "Book of Fasting, 2017",
    narrator: "Aisha",
  },
  {
    id: 9,
    category: "Supplication",
    text: "The supplication of a fasting person is never rejected.",
    source: "Sunan Ibn Majah",
    chapter: "Book of Fasting, 1643",
    narrator: "Abu Huraira",
  },
  {
    id: 10,
    category: "Forgiveness",
    text: "The one who fasts Ramadan with faith and seeking reward, all his past sins will be forgiven.",
    source: "Sahih Muslim",
    chapter: "Book of Fasting, 760",
    narrator: "Abu Huraira",
  },
  {
    id: 11,
    category: "Mercy",
    text: "Ramadan is the month whose beginning is mercy, its middle is forgiveness, and its end is freedom from the fire.",
    source: "Sunan Al-Kubra",
    chapter: "Book of Fasting, 2492",
...
export const ramadanDuas: Dua[] = [
  {
    ...
    arabic:
      "نَوَيْتُ صَوْمَ غَدٍ مِنْ شَهْرِ رَمَضَانَ الْمُبَارَكِ، فَرْضًا لَكَ يَا اللهُ، فَتَقَبَّلْ مِنِّي",
    transliteration:
      "Nawaitu sawma ghadin min shahri Ramadanal-mubaraki, fardan laka ya Allah, fataqabbal minni",
    translation:
      "I intend to fast tomorrow in this month of blessed Ramadan, obligatory for You, O Allah, so accept this from me.",
    reference: "Abu Dawud",
...
export const ramadanPrayers: RamadanPrayer[] = [
  {
    ...
    arabicTitle: "دعاء نية الصيام",
    description:
      "A supplication to make the intention for fasting during the month of Ramadan.",
    virtues: [
    ...
    howTo:
      "Recite this dua before Suhoor with the intention of fasting for the sake of Allah.",
    references: ["Hadith Collection", "Islamic Scholars' Commentary"],
  },
  {
    ...
    references: ["Sunan Abu Dawood", "Prophetic Tradition"],
  },
  {
    title: "Dua for Laylatul Qadr",
    arabicTitle: "دعاء ليلة القدر",
    description:
      "A powerful supplication for seeking forgiveness on the Night of Decree.",
    virtues: [
    ...
    howTo:
      "Recite this dua frequently during the last ten nights of Ramadan, especially on the odd nights.",
    references: ["Sunan At-Tirmidhi", "Hadith Narrations"],
  },
  {
    ...
    howTo:
      "Recite this dua during prayers, in sujood (prostration), and at any time during Ramadan.",
    references: ["Surah Al-Mu'minun (23:118)", "Quranic Commentary"],
  },
  {
    title: "Dua for Guidance and Piety",
    arabicTitle: "دعاء الهداية والتقوى",
    description:
      "A supplication asking for Allah's guidance and righteousness.",
    virtues: [
    ...
    howTo:
      "Recite this dua regularly, especially in prayers and during moments of reflection.",
    references: ["Quran & Sunnah", "Islamic Scholars' Commentary"],
  },
];
